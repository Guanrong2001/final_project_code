...
# 训练神经网络分类器
nn_classifier_new = MLPClassifier(hidden_layer_sizes=(100,20), max_iter=500, random_state=42)
nn_classifier_new.fit(X_new_train, y_new_train)

# 预测
y_new_pred = nn_classifier_new.predict(X_new_test)
...
# 保存结果到txt文件
results_path = 'neural_network_results.txt'
